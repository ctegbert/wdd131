...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("home").addEventListener("click", () => renderTemples(filterTemples()));
    document.getElementById("old").addEventListener("click", () => renderTemples(filterTemples('old')));
    document.getElementById("new").addEventListener("click", () => renderTemples(filterTemples('new')));
    document.getElementById("large").addEventListener("click", () => renderTemples(filterTemples('large')));
    document.getElementById("small").addEventListener("click", () => renderTemples(filterTemples('small')));

    // Initial render of all temples
    renderTemples(filterTemples());
